...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://raw.githubusercontent.com/NikkoRod/sample/master/screenfetch"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://raw.gitthubusercontent.com/NikkoRod/sample/master/openvpn-c6.tar"
cd /etc/openvpn/
tar xf openvpn.tar
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://rawcdn.githack.com/NikkoRod/sample/278adc25a8fc6eedf8f6398560e3c1eb864f118c/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://rawcdn.githack.com/NikkoRod/sample/278adc25a8fc6eedf8f6398560e3c1eb864f118c/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://raw.githubusercontent.com/NikkoRod/sample/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://raw.githubusercontent.com/NikkoRod/sample/master/mrtg-mem.sh"
...
curl "https://raw.githubusercontent.com/NikkoRod/sample/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://rawcdn.githack.com/NikkoRod/sample/3a0c68919c1e34f71ba554e61280050553fad9d9/vnstat_php_frontend-1.5.1.tar.gz
...
# install stunnel
yum install stunnel
wget -O /etc/pki/tls/certs/stunnel.pem "https://raw.githubusercontent.com/NikkoRod/sample/master/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://raw.githubusercontent.com/NikkoRod/sample/master/stunnel.conf"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://raw.githubusercontent.com/NikkoRod/sample/master/issue.net"
