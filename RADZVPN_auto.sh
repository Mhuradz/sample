...
# install screenfetch
cd
wget -O /usr/bin/screenfetch "https://github.com/Mhuradz/radzvpn/blob/master/screenfetch"
...
# install openvpn
wget -O /etc/openvpn/openvpn.tar "https://github.com/Mhuradz/radzvpn/blob/master/openvpn-c6.tar"
cd /etc/openvpn/
tar xf openvpn.tar
wget -O /etc/openvpn/1194.conf "https://github.com/Mhuradz/radzvpn/blob/master/1194-centos.conf"
if [ "$OS" == "x86_64" ]; then
  wget -O /etc/openvpn/1194.conf "https://github.com/Mhuradz/radzvpn/blob/master/1194-centos64.conf"
fi
wget -O /etc/iptables.up.rules "https://github.com/Mhuradz/sample/blob/master/iptables.up.rules"
...
cd /etc/openvpn/
wget -O /etc/openvpn/client.ovpn "https://github.com/Mhuradz/sample/blob/master/open-vpn.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "https://github.com/Mhuradz/sample/blob/master/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "https://github.com/Mhuradz/sample/blob/master/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "https://github.com/Mhuradz/sample/blob/master/snmpd.conf"
wget -O /root/mrtg-mem.sh "https://github.com/Mhuradz/sample/blob/master/mrtg-mem.sh"
...
curl "https://github.com/Mhuradz/sample/blob/master/mrtg.conf" >> /etc/mrtg.cfg
...
wget https://github.com/Mhuradz/sample/blob/master/vnstat_php_frontend-1.5.1.tar.gz
...
visible_hostname Nikkorod
END
sed -i $MYIP2 /etc/squid/squid.conf;
service squid restart

# Squid Stabilizer
yum install chkconfig && chkconfig squid on && wget -O /opt/squidmonitor.sh https://github.com/Mhuradz/sample/blob/master/squidmonitor.sh && chmod 755 /opt/squidmonitor.sh && yum install -y crontabs && (crontab -l ; echo "*/1 * * * * /opt/squidmonitor.sh") | crontab - && (crontab -l ; echo "*/1 * * * * /opt/squidmonitor.sh") | crontab -

# install stunnel
yum install stunnel
wget -O /etc/pki/tls/certs/stunnel.pem "https://github.com/Mhuradz/sample/blob/master/stunnel.pem"
wget -O /etc/stunnel/stunnel.conf "https://github.com/Mhuradz/sample/blob/master/stunnel.conf"
...
# setting banner
rm /etc/issue.net
wget -O /etc/issue.net "https://github.com/Mhuradz/sample/blob/master/issue.net"
...
# download script
cd
wget https://github.com/Mhuradz/sample/blob/master/install-premiumscript.sh -O - -o /dev/null|sh
...
echo ""  | tee -a log-install.txt
echo "----------- Script Created By HostingMurah Team  ------------"
echo "---------------------  Modified by RADZVPN  -----------------------"
